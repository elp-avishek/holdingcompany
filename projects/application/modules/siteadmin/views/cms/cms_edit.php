<?php //echo $edit_detail['cms_status'];die; ?>
<div class="">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <?php
                    echo form_open(base_url() . "siteadmin/cms/cms_edit_process/".$edit_detail['cms_id'], array("class" => "form-horizontal form-label-left", "name" => "cms"));
                    ?>  
                    <p><?php
			    ...
			    <input id="title" class="form-control col-md-7 col-xs-12"  name="title" placeholder="Enter Name" required="required" type="text" value="<?php echo $edit_detail['cms_title']; ?>" <?php if($edit_detail['cms_id'] == 1){?>readonly<?php }?>>
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input id="url" class="form-control col-md-7 col-xs-12"  name="url" placeholder="Enter URL" required="required" type="text" value="<?php echo $edit_detail['cms_url']; ?>" <?php if($edit_detail['cms_id'] == 1){?>readonly<?php }?>>
                        </div>
                    </div>
                    <div class="item form-group">
