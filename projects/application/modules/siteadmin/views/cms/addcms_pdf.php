    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <?php
                    echo form_open_multipart(base_url() . "siteadmin/cms/cms_pdf_add_process/", array("class" => "form-horizontal form-label-left", "name" => "cms"));
                    ?>  
                    <p><?php
...
<!--		    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input id="cms_file_title" class="form-control col-md-7 col-xs-12"  name="cms_file_title" placeholder="Enter File Title" required="required" type="text" value="">
                        </div>
                    </div>
		    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input id="cms_file_date" class="form-control col-md-7 col-xs-12"  name="cms_file_date" placeholder="Enter File Date" required="required" type="text" value="">
                        </div>
                    </div>-->
		    <div class="item form-group">
