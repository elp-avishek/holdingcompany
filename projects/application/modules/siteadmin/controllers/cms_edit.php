        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
		    ...
		    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                           <p>
                                Yes :
                                <input type="radio" class="flat" name="cms_menu" id="banner_typeI" value="Y" <?php if($edit_detail['cms_status'] == "Y"){?> checked="" <?php }?> required /> No :
                                <input type="radio" class="flat" name="cms_menu" id="banner_typeV" value="N" <?php if($edit_detail['cms_status'] == "N"){?>checked="" <?php }?>/>
                            </p>
                        </div>
                    </div>
