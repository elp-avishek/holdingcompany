...
<!--	<h3>Holdingcompany Services</h3>
	<p>
	    Holdingcompany provides corporate finance advisory services to companies, investors and transaction intermediaries that seek independent business valuations, merger and acquisition synergy value analyses, fundraising private placement preparations and investment term sheet structuring.
	</p>-->
    </div> 
	<div class="col-md-6 col-xs-12 col-sm-6">
